...
Official public presentation for TRI-GLAV, a mountain-safety product concept in development.

## Public status

- TRI-GLAV is not yet a downloadable application.
- Offline navigation, route-aware alerts and the safety flow are development goals, not released functionality.
